      ...
      <div className="mx-auto grid w-full max-w-[1800px] gap-10 px-4 py-14 md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:px-8 md:py-16 lg:px-10">
        ...
        <nav aria-label="Contact" className="space-y-6">
          ...
          <ul className="space-y-4 text-[0.64rem] uppercase tracking-[0.19em]">
            <li>
              <Link href="https://instagram.com/valentemodels" target="_blank" rel="noopener noreferrer" className="inline-block leading-none transition-opacity hover:opacity-65">
                @valentemodels
              </Link>
            </li>
            <li>
        ...
        <nav aria-label="Legal" className="space-y-6">
          ...
          <ul className="space-y-4 text-[0.64rem] uppercase tracking-[0.19em]">
            <li>
              <Link href="/ethics-code" className="inline-block leading-none transition-opacity hover:opacity-65">
                Ethics Code
              </Link>
            </li>
            <li>
              <Link href="/terms-legal" className="inline-block leading-none transition-opacity hover:opacity-65">
                Terms &amp; Legal
              </Link>
            </li>
          </ul>
